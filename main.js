...
"use strict";
    ...
    (function renderLegend() {
      ...
      rows.unshift('<li><span class="swatch" style="background:#FFD9A0"></span>Core — shell</li>');
      rows.push('<li><span class="swatch" style="background:#D8B4FE;border-radius:0"></span>Constellation — identity</li>');
    ...
    function openPanel(b) {
      ...
      if (b.plain) h.push('<div class="plain"><span>in plain english</span>' + b.plain + '</div>');
    ...
    function focusBody(b, withPanel) {
      ...
      flyTo({ dist: d, pitch: clamp(cam.pitch, 0.12, 0.6) }, 1.25);
